...
var (
	...
	// CRLF is the line separator of slava serialization protocol
	CRLF = "\r\n"
)
...
func MakeMultiRawReply(replies []slava.Reply) *MultiRawReply {
...
func IsOKReply(reply slava.Reply) bool {
...
// ErrorReply is an error and slava.Reply
...
func IsErrorReply(reply slava.Reply) bool {

...
// AssertIntReply checks if the given slava.Reply is the expected integer
func AssertIntReply(t *testing.T, actual slava.Reply, expected int) {
...
func AssertIntReplyGreaterThan(t *testing.T, actual slava.Reply, expected int) {
	intResult, ok := actual.(*protocol.IntReply)
	if !ok {
		t.Errorf("expected int protocol, actually %s, %s", actual.ToBytes(), printStack())
		return
...
// AssertBulkReply checks if the given slava.Reply is the expected string
func AssertBulkReply(t *testing.T, actual slava.Reply, expected string) {
...
// AssertStatusReply checks if the given slava.Reply is the expected status
func AssertStatusReply(t *testing.T, actual slava.Reply, expected string) {
...
// AssertErrReply checks if the given slava.Reply is the expected error
func AssertErrReply(t *testing.T, actual slava.Reply, expected string) {
...
// AssertNotError checks if the given slava.Reply is not error protocol
func AssertNotError(t *testing.T, result slava.Reply) {
	if result == nil {
...
// AssertNullBulk checks if the given slava.Reply is protocol.NullBulkReply
func AssertNullBulk(t *testing.T, result slava.Reply) {
	if result == nil {
		t.Errorf("result is nil %s", printStack())
		return
	}
...
// AssertMultiBulkReply checks if the given slava.Reply has the expected content
func AssertMultiBulkReply(t *testing.T, actual slava.Reply, expected []string) {
...
// AssertMultiBulkReplySize check if slava.Reply has expected length
func AssertMultiBulkReplySize(t *testing.T, actual slava.Reply, expected int) {
	multiBulk, ok := actual.(*protocol.MultiBulkReply)
	if !ok {
		if expected == 0 &&

...
func Copy(cluster *Cluster, c slava.Connection, args [][]byte) slava.Reply {
	if len(args) < 3 {
...
func prepareCopyFrom(cluster *Cluster, conn slava.Connection, cmdLine aof.CmdLine) slava.Reply {
	if len(cmdLine) != 2 {
...
func prepareCopyTo(cluster *Cluster, conn slava.Connection, cmdLine aof.CmdLine) slava.Reply {
	if len(cmdLine) != 5 {

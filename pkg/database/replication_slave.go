...
func (server *Server) execSlaveOf(c slava.Connection, args [][]byte) slava.Reply {
...
func (server *Server) connectWithMaster(configVersion int32) (bool, error) {
	...
	sendCmdToMaster := func(conn net.Conn, cmdLine aof.CmdLine, masterChan <-chan *parser.Payload) error {
